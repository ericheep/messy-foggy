    ...
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 107.0, 129.5, 81.0, 22.0 ],
                    "text": "loadmess -10"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 79.0, 90.5, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ 37.0, 20.5, 143.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 79.0, 51.5, 152.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "parameter_enable": 1,
                    "patching_rect": [ 37.0, 170.5, 43.0, 51.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 37.0, 89.5, 24.0, 24.0 ]
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 37.0, 129.5, 61.0, 22.0 ],
                    "text": "p saveMe"
                }
            },
            {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-2", 0 ],
                    "midpoints": [ 46.5, 240.0, 46.5, 240.0 ],
                    "source": [ "obj-80", 0 ]
                }
            },
            {
